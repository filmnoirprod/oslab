...
static int lunix_chrdev_open(struct inode *inode, struct file *filp)
{
	...
	minor = iminor(inode) ;           // get the minor number of the sensor
        ...
        device = minor % 8 ;             // device value is 0 for batt , 1 for temp and 2 for light
...
/* some comments for the read's function arguments -->

 * filp is the open file of the driver 
 * usrbuf is a pointer to the user buffer
 * cnt is the size of requested data to be transferred
 * f_pos is a pointer that indicates the file position that the user is accessing
